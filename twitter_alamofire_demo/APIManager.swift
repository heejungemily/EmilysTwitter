...
class APIManager: SessionManager {
    ...
    static let consumerKey = "gfhXSNhLnSrE5VQjcsmvcGbsD"
    static let consumerSecret = "PC18YMV9rKHcoTdc77Na7JzFuyLseaQWPZS4q3HDf0CvYc8nw6"
...
//        }
    ...
    func composeReply(with text: String, tweet: Tweet, completion: @escaping (Tweet?, Error?) -> ()) {
        let urlString = "https://api.twitter.com/1.1/statuses/update.json"
        let parameters: [String: Any] = [
            //"status": "@\(tweet.user.screenName) \(text)",
